...
try {
    switch ($command) {
        ...
        case 'show-entity':
            if ($argc < 3) {
                echo "❌ Uso: php doctrine-cli.php show-entity <NomeDaEntidade>\n";
                echo "Exemplo: php doctrine-cli.php show-entity App\\Entities\\User\n";
                exit(1);
            }
...
function showHelp(): void
{
    ...
    echo "  php doctrine-cli.php create-schema\n";
    echo "  php doctrine-cli.php list-entities\n";
    echo "  php doctrine-cli.php show-entity App\\Entities\\User\n";
    echo "  php doctrine.php orm:mapping:describe App\\Entities\\User\n\n";
    
    echo "📋 COMANDOS DOCTRINE ORIGINAIS MAIS ÚTEIS:\n";
    echo "  php doctrine.php orm:mapping:describe <Entity>     Descrever mapeamento\n";
    echo "  php doctrine.php orm:validate-schema                Validar esquema\n";
    echo "  php doctrine.php orm:schema-tool:create             Criar esquema\n";
    echo "  php doctrine.php orm:schema-tool:update             Atualizar esquema\n";
    echo "  php doctrine.php orm:schema-tool:drop               Dropar esquema\n";
    echo "  php doctrine.php migrations:generate                Gerar migração\n";
    echo "  php doctrine.php migrations:migrate                 Executar migrações\n";
    echo "  php doctrine.php migrations:status                  Status das migrações\n";
}
